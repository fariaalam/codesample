...
int fn,run;
int a,b,c1,callDE,callABC,callIFEP;
...
int main(int argc, char *argv[])
{
	...
	srand(time_t(t));
	FILE *f;
	f = fopen("Hybrid_Data(DE,ABC,IFEP) Adaptive.txt", "w");
	fclose(f);
	f=fopen("Hybrid4/Function1.txt","w");
	fclose(f);
	f=fopen("Hybrid4/Function2.txt","w");
	fclose(f);
	f=fopen("Hybrid4/Function3.txt","w");
	fclose(f);
	f=fopen("Hybrid4/Function4.txt","w");
	fclose(f);
	f=fopen("Hybrid4/Function5.txt","w");
	fclose(f);
	f=fopen("Hybrid4/Function6.txt","w");
	fclose(f);
	f=fopen("Hybrid4/Function7.txt","w");
	fclose(f);
	...
	for (fn = 1; fn <= func; fn++)
	{
		...
		abc:
			...
			{
				it = i;
				changeDE = fabs(minStartDE - minEndDE);// / fabs(minStartDE);
				changeABC = fabs(minStartABC - minEndABC);// / fabs(minStartABC);
				changeIFEP = fabs(minStartIFEP - minEndIFEP);// / fabs(minStartIFEP);
				long double whole = changeDE + changeABC + changeIFEP;
				changeDE = changeDE / whole;
				changeABC = changeABC / whole;
				changeIFEP = changeIFEP / whole;
				a = (int)round(changeDE * 15);
				b = (int)round(changeABC * 15);
				c1 = (int)round(changeIFEP * 15);
				if (a > 12)
					a = 12;
				if (b > 12)
					b = 12;
				...
				if ((a + b + c1) > 15)
				{
					if (max(a, b, c1) == a)
						a = a - 1;
					else if (max(a, b, c1) == b)
						b = b - 1;
					else if (max(a, b, c1) == c1)
						c1 = c1 - 1;
				}
				if ((a + b + c1) < 15)
				{
					if (min(a, b, c1) == a)
						a = a + 1;
					else if (min(a, b, c1) == b)
						b = b + 1;
					else if (min(a, b, c1) == c1)
						c1= c1 + 1;
				}
				if ((a < 0 || b < 0 || c1 < 0 || a>32767 || b>32767 || c1>32767))
				{
					a = (rand() % 12) + 1;
					b = (rand() % (15 - a - 1)) + 1;
					c1 = 15 - a - b;
				...
				if( (r1==a) || (r1<a && a<=b && a<=c1) || (r1>a && a>=b && a>=c1) || (r1>=b && r1<=a && a<c1) || (r1>=c1 && r1<=a && a<b) )
				{
					for(int ijk=0;ijk<a;ijk++)
					{
						callDE++;
					...
					int r2=rand()%(b+c1)+1;
					if( (r2==b) || (b<c1 && r2<b ) || (b>c1 && r2>b) || (r2>c1 && r2<=b) )
					{
						for(int ijk=0;ijk<b;ijk++)
						{
							callABC++;
					...
					else if( (r2==c1) || (c1<b && r2<c1 ) || (c1>b && r2>c1) || (r2>b && r2<=c1) )
					{
						for(int ijk=0;ijk<c1;ijk++)
						{
							callIFEP++;
				...
				else if( (r1==b) || (r1<b && b<=a && b<=c1) || (r1>b && b>=a && b>=c1) || (r1>=a && r1<=b && b<c1) || (r1>=c1 && r1<=b && b<a) )
				{
					for(int ijk=0;ijk<a;ijk++)
					{
						callABC++;
					...
					int r2=rand()%(a+c1)+1;
					if( (r2==a) || (a<c1 && r2<a ) || (a>c1 && r2>a) || (r2>c1 && r2<=a) )
					{
						for(int ijk=0;ijk<a;ijk++)
						{
							callDE++;
					...
					else if( (r2==c1) || (c1<a && r2<c1 ) || (c1>a && r2>c1) || (r2>a && r2<=c1) )
					{
						for(int ijk=0;ijk<c1;ijk++)
						{
							callIFEP++;
				...
				else if( (r1==c1) || (r1<c1 && c1<=a && c1<=b) || (r1>c1 && c1>=a && c1>=b) || (r1>=a && r1<=c1 && c1<b) || (r1>=a && r1<=c1 && c1<a) )
				{
					for(int ijk=0;ijk<a;ijk++)
					{
						callABC++;
					...
					int r2=rand()%(a+b)+1;
					if( (r2==a) || (a<b && r2<a ) || (a>b && r2>a) || (r2>b && r2<=a) )
					{
						for(int ijk=0;ijk<a;ijk++)
						{
							callDE++;
					...
					else if( (r2==b) || (b<a && r2<b ) || (b>a && r2>b) || (r2>a && r2<=b) )
					{
						for(int ijk=0;ijk<b;ijk++)
						{
							callABC++;
		...
		f = fopen("Hybrid_Data(DE,ABC,IFEP) Adaptive.txt", "a+");
...
void mainDE()
{
	FILE *f;
		...
		if(run==9)
		{
			if(fn==1)
			{
				f=fopen("Hybrid4/Function1.txt","a+");
				fprintf(f,"%e\n",GlobalMin);
				fclose(f);
			}
		    else if(fn==2)
			{
			    f=fopen("Hybrid4/Function2.txt","a+");
				fprintf(f,"%e\n",GlobalMin);
				fclose(f);
		    }
			else if(fn==3)
		    {
				f=fopen("Hybrid4/Function3.txt","a+");
				fprintf(f,"%e\n",GlobalMin);
				fclose(f);
			}
			else if(fn==4)
			{
				f=fopen("Hybrid4/Function4.txt","a+");
				fprintf(f,"%e\n",GlobalMin);
				fclose(f);
			}
			else if(fn==5)
			{
				f=fopen("Hybrid4/Function5.txt","a+");
				fprintf(f,"%e\n",GlobalMin);
				fclose(f);
			}
			else if(fn==6)
			{
				f=fopen("Hybrid4/Function6.txt","a+");
				fprintf(f,"%e\n",GlobalMin);
				fclose(f);
			}
			else if(fn==7)
			{
				f=fopen("Hybrid4/Function7.txt","a+");
				fprintf(f,"%e\n",GlobalMin);
				fclose(f);
			}
		}
