<?php  
									if(isset($_GET['add'])){
										...
										mysqli_query($con,"INSERT INTO `director` (`department`,`name`,`address`,`phone_number`,`appointment_date`,`email`,`password`)
									...
									if(isset($_GET['update'])){
										...
										mysqli_query($con," UPDATE `director` SET  `performance` =  '$performance', 
										...
										mysqli_query($con," UPDATE `director` SET  `department` =  '$department', 
									...
									if(isset($_GET['delete'])){
										...
										mysqli_query($con,"DELETE FROM `director` WHERE director_id='$id'");
									}
								?>
<div id="main-content">
		<div class="page-title">
			<div>
				<h1><i class="icon-desktop"></i>Director</h1>
					...
					<div class="box-content">
						<div class="tab-content">
												...
												<tr>
													...
													<?php 
														if($_SESSION['login_type'] == 'admin' ||
                                                           $_SESSION['login_type'] == 'managing_director') {
													?>
													<td><a href="index.php?page=director&edit=<?php echo $row['director_id']; ?>" >Edit</a></td>
													<td><a href="index.php?page=director&delete=<?php echo $row['director_id']; ?>" onclick="return confirm('Are you sure to delete this?')" >Delete</a></td>
													<?php } ?>
												</tr>
											  <?php	}?>
											<!--php loop end -->
							...
							<div class="tab-pane" id="add">
								...
								<div class="box-content">
									<form action="index.php?page=director&add=do" class="form-horizontal" method="post">
							...
							<?php 							
								if(isset($_GET['edit'])){
								$dir = $_GET['edit'];
							   $result = mysqli_query($con,"SELECT * FROM director WHERE director_id='$dir'");
							   while($row = mysqli_fetch_array($result)){
							?>
							<div class="tab-pane active" id="edit">
								<form action="index.php?page=director&update=do" method="post" class="form-horizontal">
								   	<?php 
														if($_SESSION['login_type'] == 'admin' ||
                                                           $_SESSION['login_type'] == 'managing_director') {
													?>
                                       ...
                                       <?php }?>										
										...
										<input type="hidden" name="id" value='<?php echo $dir; ?>' />
									<div class="form-actions">
									   <button type="submit" class="btn btn-primary"><i class="icon-ok"></i> Save</button>
									</div>
								</form>
