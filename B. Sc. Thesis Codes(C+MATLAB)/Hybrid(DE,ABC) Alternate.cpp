...
int main(int argc, char *argv[])
{
	...
	srand(time_t(t));
	FILE *f;
	f = fopen("Hybrid_Data(DE,ABC) Alternate.txt", "w");
	fclose(f);
	f=fopen("Hybrid1/Function1.txt","w");
	fclose(f);
	f=fopen("Hybrid1/Function2.txt","w");
	fclose(f);
	f=fopen("Hybrid1/Function3.txt","w");
	fclose(f);
	f=fopen("Hybrid1/Function4.txt","w");
	fclose(f);
	f=fopen("Hybrid1/Function5.txt","w");
	fclose(f);
	f=fopen("Hybrid1/Function6.txt","w");
	fclose(f);
	...
	for (int fn = 1; fn <= func; fn++)
	{
		...
		abc:
			...
			for (int i = 0; i < maxCycle; i++)
			{
				...
				if(run==9)
				{
					if(fn==1)
					{
						f=fopen("Hybrid1/Function1.txt","a+");
						fprintf(f,"%e\n",GlobalMin);
						fclose(f);
					}
					else if(fn==2)
					{
						f=fopen("Hybrid1/Function2.txt","a+");
						fprintf(f,"%e\n",GlobalMin);
						fclose(f);
					}
					else if(fn==3)
					{
						f=fopen("Hybrid1/Function3.txt","a+");
						fprintf(f,"%e\n",GlobalMin);
						fclose(f);
					}
					else if(fn==4)
					{
						f=fopen("Hybrid1/Function4.txt","a+");
						fprintf(f,"%e\n",GlobalMin);
						fclose(f);
					}
					else if(fn==5)
					{
						f=fopen("Hybrid1/Function5.txt","a+");
						fprintf(f,"%e\n",GlobalMin);
						fclose(f);
					}
					else if(fn==6)
					{
						f=fopen("Hybrid1/Function6.txt","a+");
						fprintf(f,"%e\n",GlobalMin);
						fclose(f);
					}
				}
		...
		f = fopen("Hybrid_Data(DE,ABC) Alternate.txt", "a+");
